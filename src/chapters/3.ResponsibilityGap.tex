...
% Example
We hereby provide an example that contextualizes the non-applicability of the traditional framework to AI systems in a plausible scenario: \todo{insert example}